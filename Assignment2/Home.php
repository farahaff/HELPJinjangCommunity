...
<body>
  ...
  <nav class="navbar navbar-pills">
    <div class="container-fluid">
      ...
      <a class="navbar-brand" href="Home.php"><img src="AssignmentImage/HELPFit Logo.png" alt="logo" width="100" height="80">
      </a>
      </div>
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav navbar-left">
          ...
          <li class="active"><a href="RecordGroupTraining.php">Record Group Training</a></li>
          <li class="active"><a href="RecordPersonalTraining.php.php">Record Personal Training</a></li>
