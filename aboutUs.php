      ...
      <div class="container" id="about">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading text-uppercase">About AGN</h2><br>
            <h3 class="section-subheading text-muted">
              ACTS Global Networking (AGN) is a non-profit organization mainly focusing on education and social concern activities.
              One of the community activities that it has been involved in over the past fourteen years is its “street ministry” where the organization reaches out and helps the hurting and neglected children and youth in Jinjang.
              AGN has been extending support, counselling and meeting the material needs of this needful community for over fourteen years.

            </h3><hr><br><br>
      <div class="container" id="literacy">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading text-uppercase">Literacy and Numeracy Programme</h2><br>
